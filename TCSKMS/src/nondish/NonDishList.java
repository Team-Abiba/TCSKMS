...
public class NonDishList extends javax.swing.JFrame {
    ...
    public void paginateTable(int os){
        NonDishModel nd = new NonDishModel();
        
        this.getTable().setModel(DbUtils.resultSetToTableModel(nd.loadTenNonDish(offSet)));
        this.getTable().createDefaultColumnsFromModel();
        this.getTable().getTableHeader().setReorderingAllowed(false);
        TableRowFilterSupport.forTable(this.getTable()).searchable(true).apply();
        sorter = new TableRowSorter(DbUtils.resultSetToTableModel(nd.loadTenNonDish(offSet)));
        this.getTable().setRowSorter(sorter);
    }
    ...
    private void initComponents() {
        ...
        btnNext.setText(">");
        btnNext.setSize(new java.awt.Dimension(97, 29));
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        offSet += 10;
        page += 1;
        checking = nd.checkHaveResult(offSet);
        if(0 == checking){
            JOptionPane.showMessageDialog(null, "No more results to show","Page",JOptionPane.INFORMATION_MESSAGE);
            offSet -= 10;
            page -= 1;
